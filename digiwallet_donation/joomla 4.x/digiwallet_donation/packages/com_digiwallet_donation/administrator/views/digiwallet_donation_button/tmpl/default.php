...
<form action="<?php echo JRoute::_('index.php?option=com_digiwallet_donation&layout=edit&id=' . $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
    <div class="row-fluid">
        <div class="span10 form-horizontal">
            ...
            <div style="background: red; color: white; width: fit-content; padding: 2px 5px;">{digidonate <?= $this->item->id ? $this->item->id : 'buttonId' ; ?>}</div>
            <div style="font-size: 70%;">You should enable the plugin <b>Digiwallet Donate Button</b> to make it work.</div>
            <br/>
